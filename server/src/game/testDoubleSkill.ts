...
console.log(
  "Double Skill remaining:",
  game.getDoubleSkillActivationsRemaining("player1")
);

console.log(
  "Max skill cards before Double Skill:",
  game.getMaxSkillCardsThisTurn()
);

game.activateDoubleSkill("player1");

console.log(
  "Max skill cards after Double Skill:",
  game.getMaxSkillCardsThisTurn()
);
...
console.log(
  "Max skill cards after Player 1 turn:",
  game.getMaxSkillCardsThisTurn()
);
